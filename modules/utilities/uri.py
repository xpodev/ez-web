...
class URIAuthority:
    ...
    def __init__(self, userinfo: URIUserInfo, host: str, port: int) -> None:
...
class UnifiedResourceIdentifier:
    ...
    def __init__(self, scheme: str, authority: URIAuthority, path: str, query: str, fragment: str, raw: str) -> None:
        self.scheme = scheme
